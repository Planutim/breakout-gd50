...
function Brick:init(x,y)
    ...
    -- which is clumpy; numbers are amount of standard deviation
    -- away in X and Y axis
...
function Brick:hit()
    ...
    -- in this case, we give it our self.color  with varying alpha;
    -- brighter for higher tiers, fading to 0
